...
function Carbooking() {
    ...
    return (
        <>
            <div className="carcontainer transition_hide">
                <div className="carcontant">
                    <div className="cartitle">
                        <p className="p">
                            🚐🚗 Need the perfect ride? JK Tours & Travels offers both vans and cars for every trip! From comfy mini vans for groups to stylish cars for personal travel—enjoy clean vehicles, pro drivers, and smooth journeys. Book now for hassle-free travel! 🌟✨
                        </p>
                        <a href="https://wa.me/919904803601" target="_blank" className="booking_btn"><div>Book Now Vehicle</div></a>
                    </div>
                </div>
