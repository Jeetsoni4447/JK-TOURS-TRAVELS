            ...
            <div className="maincontainer_1 transition_hide">
                ...
                <div className="block_compo">
                    <div className="block transition_hide">
                        <img src="./public/reliability.webp" alt="jktours" className="block_img_1" />
                    ...
                    <div className="block transition_hide">
                        <img src="./public/professionalism.webp" alt="jktours" className="block_img_2" />
                    ...
                    <div className="block transition_hide">
                        <img src="./public/affordability.webp" alt="jktours" className="block_img_3" />
            ...
            <div className="maincontainer_2 transition_hide">
                ...
                <div className="block_comp_1">
                    <div className="b_1 transition_hide">
                        <img src="./public/car.webp" alt="jktours" className="block_img_4" />
                    ...
                    <div className="b_1 transition_hide">
                        <img src="./public/round-trip.webp" alt="jktours" className="block_img_5" />
                    ...
                    <div className="b_1 transition_hide">
                        <img src="./public/one-way.webp" alt="jktours" className="block_img_6" />
                    ...
                    <div className="b_1 transition_hide">
                        <img src="./public/flight_ticket.webp" alt="jktours" className="block_img_7" />
                    ...
                    <div className="b_1 transition_hide">
                        <img src="./public/train_ticket.webp" alt="jktours" className="block_img_8" />
                    ...
                    <div className="b_1 transition_hide">
                        <img src="./public/bus.webp" alt="jktours" className="block_img_9" />
                    ...
                    <div className="b_1 transition_hide">
                        <img src="./public/packages.webp" alt="jktours" className="block_img_10" />
                    ...
                    <div className="b_1 transition_hide">
                        <img src="./public/travelling_visa.webp" alt="jktours" className="block_img_11" />
